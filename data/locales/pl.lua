locale = {
  ...
  translation = {
    ...
    ["All"] = "Wszystkie",
    ["Allow auto chase override"] = "Zezwalaj na automatyczne nadpisywanie scigania",
    ["Allow VIPs to message you"] = "Zezwalaj VIP-om na wysyłanie wiadomosci",
    ["Allowed Players"] = "Dozwoleni Gracze",
    ["Also known as dash in tibia community, recommended\nfor playing characters with high speed"] = "Inaczej znane jako dash w społecznosci Tibii, polecane\ndo grania postaciami o duzej predkosci",
    ...
    ["Author"] = "Autor",
    ["Auto login selected character on next charlist load"] = "Automatycznie zaloguj wybrana postac podczas kolejnego ladowania listy postaci",
    ...
    ["Clear current message window"] = "Wyczysc biezace okno",
    ...
    ["Draw Viewport Edge"] = "Rysuj krawedz widoku",
    ["Druid"] = false,
    ["Edit %s"] = "Edycja %s",
    ...
    ["You read the following, written by \n%s\n"] = "Przeczytales nastepujacy tekst, napisany przez \n%s\n",
    ["You read the following, written on \n%s.\n"] = "Przeczytales nastepujacy tekst, napisany na \n%s.\n",
    ["Your Capacity"] = "Twoj udzwig",
    ["Your Capacity:"] = "Twoja Ladownosc:",
    ["Your client needs updating, try redownloading it."] = "Twoj klient wymaga aktualizacji, sprobuj pobrac go ponownie.",
    ...
    ["Your request has been closed"] = "Twoje zadanie zostalo zamkniete",
      ...
      ["On skill circle"] = "Na kole umiejetnosci",
      ["Skill:"] = "Umiejetnosc:",
      ...
      ['Music Volume: %d'] = 'Glosnosc Muzyki: %d',
      ['Sound Effects Volume: %d'] = 'Glosnosc Efektow: %d',
      ['Ambient Sound Volume: %d'] = 'Glosnosc Otoczenia: %d',
      ["Distance: %s"] = "Dystans: %s",
      ["Locked"] = "Zablokowany",
      ["Normal"] = "Normalny",
      ["Fade"] = "Zanikajacy",
      ["Always with transparency"] = "Transparentny",
      ["Always"] = "Realistyczny",
      ["None"] = "Brak",
      ['Highlight items in different colors (loot channel):'] = "Podswietl przedmioty w roznych kolorach (kanal lootu):",
      ["Color: %s, From: %d, To: %d"] = "Kolor: %s, Od: %d, Do: %d",
      ["Add highlight"] = "Dodaj wyroznienie",
      ["Remove highlight"] = "Usun wyroznienie",
      ["Default highlights"] = "Podstawowe wyroznienia",
      ["Clear highlights"] = "Wyczysc wyroznienia",
      ["Please select an highlight to remove."] = "Wybierz wyroznienie do usuniecia.",
      ["Add new highlight"] = "Dodaj nowe wyroznienie",
      ["Invalid From and To values or From is not less than To."] = "Nieprawidlowe wartosci Od i Do lub Od nie jest mniejsze niz Do.",
      ["F and T range overlaps with an existing highlight."] = "Od i Do pokrywa sie z istniejacym wyroznieniem.",
      ["Specify either a Color Hex or select a Color Label, not both or neither."] = "Okresl kolor Hex lub wybierz kolor z listy, a nie oba lub zadne z nich.",
      ["Invalid hex color."] = "Nieprawidlowy kolor Hex",
      ["Color(#hex): "] = "Kolor(#hex): ",
      ["From: "] = "Od: ",
      ["To: "] = "Do: ",
      ["Color: "] = "Kolor: ",
