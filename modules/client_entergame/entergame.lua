...
function EnterGame.init()
    ...
    local host = serverIp -- g_settings.get('host')
    local port = serverPort -- g_settings.get('port')
    local stayLogged = g_settings.getBoolean('staylogged')
    local autologin = g_settings.getBoolean('autologin')
    local clientVersion = serverClient -- g_settings.getInteger('client-version')
    ...
    enterGame:getChildById('serverHostTextEdit'):setText(serverIp) -- host
    enterGame:getChildById('serverPortTextEdit'):setText(serverPort) -- port
...
function EnterGame.doLogin()
  ...
  if modules.client_options.getOption('testServer') == true then
    ...
    G.host = serverIp --enterGame:getChildById('serverHostTextEdit'):getText()
    G.port = serverPort --tonumber(enterGame:getChildById('serverPortTextEdit'):getText())
    local clientVersion = serverClient --tonumber(clientBox:getText())
    EnterGame.hide()
...
function EnterGame.setDefaultServer(host, port, protocol)
  ...
  if modules.client_options.getOption('testServer') == true then
    ...
    local portTextEdit = serverPort --enterGame:getChildById('serverPortTextEdit')
    local clientLabel = serverClient -- enterGame:getChildById('clientLabel')
