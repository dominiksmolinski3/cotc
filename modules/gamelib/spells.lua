SpelllistSettings = {
    ['Default'] = {
        ...
        spellOrder = {'Levitate', 'Annihilation', 'Brutal Strike', 'Whirlwind Throw', 'Blood Rage', 'Berserk',
                      'Front Sweep', 'Challenge', 'Fierce Berserk', 'Ethereal Shot', 'Strong Ethereal Shot', 'Ricochet',
                      'Protector', 'Sharpshooter'}
    } --[[,
  ['Custom'] =  {
