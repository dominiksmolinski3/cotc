...
function getSkullImagePath(skullId)
    ...
    elseif skullId == SkullBlack then
      ...
      elseif skullId == SkullRaid then
          path = '/images/game/skulls/skull_raid'
      elseif skullId == SkullTier1 then
          path = '/images/game/skulls/skull_tier1'
      elseif skullId == SkullTier2 then
          path = '/images/game/skulls/skull_tier2'
      elseif skullId == SkullTier3 then
          path = '/images/game/skulls/skull_tier3'
      end
