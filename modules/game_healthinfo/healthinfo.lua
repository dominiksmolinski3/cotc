...
Icons[PlayerStates.PreyBoosted] = {
    tooltip = tr('You have prey boost'),
    path = '/images/game/states/prey_boosted',
    id = 'condition_prey_boosted'
}

Icons[PlayerStates.FlaskBoosted] = {
    tooltip = tr('You are boosted from flask'),
    path = '/images/game/states/flask_boosted',
    id = 'condition_flask_boosted'
}
